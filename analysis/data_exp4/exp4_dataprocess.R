...
#for (i in 23){
  ...
  #New bit for exps 3 and 4
  for (n in 1:length(trial)){
    index = which(datstudy[n,2] == datstudy[,2]) 
    index = index[length(index)] #Sort by JOLs will have the real trial last. Made more general from Exp3 code.
